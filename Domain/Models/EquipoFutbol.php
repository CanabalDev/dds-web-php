...
class EquipoFutbol
{
    ...
    public function __construct(
        ...
        if (
            $numGoles < 0 || $numPartidosJugados < 0 || $numPartidosGanados < 0 ||
    ...
    public function getNombre(): TeamName
    {
        return $this->nombre;
    }
    ...
    public function getTecnico(): UserModel
    {
        return $this->tecnico;
    }
    public function getPais(): TeamCountry
    {
        return $this->pais;
    }
    public function getCiudad(): TeamCity
    {
        return $this->ciudad;
    }
    public function getCategoria(): TeamCategory
    {
        return $this->categoria;
    }

    public function getNumGoles(): int
    {
        return $this->numGoles;
    }
    public function getNumPartidosJugados(): int
    {
        return $this->numPartidosJugados;
    }
    public function getNumPartidosGanados(): int
    {
        return $this->numPartidosGanados;
    }
    public function getNumCampeonatos(): int
    {
        return $this->numCampeonatos;
    }
    public function getNumExpulsiones(): int
    {
        return $this->numExpulsiones;
    }
    public function getNumEmpates(): int
    {
    ...
    public function setNombre(TeamName $nombre): void
    {
        $this->nombre = $nombre;
    }
    public function setEslogan(string $eslogan): void
    {
        $this->eslogan = $eslogan;
    }
    public function setTecnico(UserModel $tecnico): void
    {
        $this->tecnico = $tecnico;
    }
    public function setPais(TeamCountry $pais): void
    {
        $this->pais = $pais;
    }
    public function setCiudad(TeamCity $ciudad): void
    {
        $this->ciudad = $ciudad;
    }
    public function setCategoria(TeamCategory $categoria): void
    {
        $this->categoria = $categoria;
    }
